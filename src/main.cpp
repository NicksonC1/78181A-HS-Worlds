...
namespace Color {
    ...
    bool isDone = false;
    constexpr double rLow = 8.0, rHigh = 20.0, bLow = 175.0, bHigh = 200.0, minProx= 80; // Values for colorSort
    constexpr double rLow1 = 9.0, rHigh1 = 20.0, bLow1 = 175.0, bHigh1 = 230.0, minProx1 = 80; // Values for ring store on intake

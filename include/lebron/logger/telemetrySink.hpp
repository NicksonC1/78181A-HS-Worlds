 ...
 *
 * This is the primary way of interacting with the telemetry portion of lebron's logging implementation. This sink is
 ...
 * <h3> Example Usage </h3>
 * @code
 * lebron::telemetrySink()->setLowestLevel(lebron::Level::INFO);
 * lebron::telemetrySink()->info("{},{}", motor1.get_temperature(), motor2.get_temperature());
 * @endcode
 */

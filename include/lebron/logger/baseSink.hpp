...
namespace lebron {
/**
 * @brief A base for any sink in lebron to implement.
 *
 * Sinks are lebron's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * lebron::BaseSink combinedSink({lebron::telemetrySink(), lebron::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(lebron::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[lebron] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
         * // This will be formatted as:
         * // "[lebron] -- 10 -- INFO:  hello"
         * @endcode
         */

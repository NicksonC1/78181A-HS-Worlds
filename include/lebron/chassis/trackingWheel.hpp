...
class TrackingWheel {
    public:
         ...
         * lebron::TrackingWheel verticalTrackingWheel(&verticalEncoder, lebron::Omniwheel::NEW_275, -5);
         ...
         * lebron::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, lebron::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * lebron::TrackingWheel leftTrackingWheel(&leftMotors, lebron::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by lebron, this will automatically be called when
         ...
         *     lebron::TrackingWheel exampleTrackingWheel(&exampleEncoder, lebron::Omniwheel::NEW_275, 0.5);
         ...
         *     lebron::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, lebron::Omniwheel::NEW_275, 0.5);

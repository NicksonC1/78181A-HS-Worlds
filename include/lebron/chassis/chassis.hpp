...
#include "lebron/asset.hpp"
#include "lebron/chassis/trackingWheel.hpp"
#include "lebron/pose.hpp"
#include "lebron/pid.hpp"
#include "lebron/exitcondition.hpp"
#include "lebron/driveCurve.hpp"
...
class OdomSensors {
    public:
         ...
         * lebron::TrackingWheel vertical1(&vertical_rotation, lebron::Omniwheel::NEW_275, 0.5);
         * lebron::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * lebron::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * lebron::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * lebron::Pose poseB(5.3, 12.2, 3.14);

 ...
 * see https://www.vexforum.com/t/expo-drive-lebrons-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * lebron::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */

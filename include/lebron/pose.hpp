...
class Pose {
    public:
         ...
         * @code {.cpp}
         * // create a pose
         * lebron::Pose poseA(5, // x position
         *                    10, // y position
         *                    1.57); // heading
         * // create a pose
         * lebron::Pose poseB(5.2, 22); // x and y position, heading defaults to 0
         * @endcode
         */
         ...
         * @code {.cpp}
         * // create a pose
         * lebron::Pose poseA(5, 10, 1.57);
         * // create a pose
         * lebron::Pose poseB(5.2, 22, 2.22);
         * // add the two poses
         * lebron::Pose poseC = poseA + poseB;
         ...
         * @code {.cpp}
         * // create a pose
         * lebron::Pose pose(1, 2);
         * // multiply the pose by 4.0
         * lebron::Pose result = pose * 4.0;
         ...
         * @code {.cpp}
         * // create a pose
         * lebron::Pose pose(6, 8);
         * // divide the pose by 2
         * lebron::Pose result = pose / 2;
         ...
         * @code {.cpp}
         * // create poses
         * lebron::Pose poseA(0, 0);
         * lebron::Pose poseB(0, 2);
         * // find the pose in between the 2 poses
         * lebron::Pose result = poseA.lerp(poseB, 0.5);
         ...
         * @code {.cpp}
         * // create poses
         * lebron::Pose poseA(-1, -2);
         * lebron::Pose poseB(2, 1);
         ...
         * @code {.cpp}
         * // create pose
         * lebron::Pose pose(1, 0);
         * // rotate pose by pi/2
         * lebron::Pose result = pose.rotate(M_PI_2);
         * // result.x = 0, result.y = 1
         * @endcode
         */
